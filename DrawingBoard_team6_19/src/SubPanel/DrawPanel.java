...
public class DrawPanel extends JPanel implements MouseMotionListener, MouseListener, Serializable{
	...
	private void drawFigureFunc(MouseEvent e)
	{
		...
		case Information.MODE_TEXT:
			...
			if(textData==null || textData.equals("")) textData=JOptionPane.showInputDialog(null,"텍스트를 입력하세요.",JOptionPane.OK_OPTION);
	...
	public void popStackTrace() //undo할 때
	{
	...
	public void popStackCaneStack() //redo할 때
	{
